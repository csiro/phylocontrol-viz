...
set_testing_golem_options(list(demo=T))
# set_testing_golem_options(list(dir_path = test_path))
...
# ref: https://stackoverflow.com/questions/75361735/run-testserver-w-golemget-golem-options
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
